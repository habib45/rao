      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center gap-4">
          ...
          <div className="flex items-center gap-3 md:gap-5">
            ...
            <Link
              href="/cart"
              className="relative inline-flex items-center justify-center rounded-full p-2 text-foreground transition-colors hover:bg-surface hover:text-brand"
              aria-label={t("cart")}
            >
              <svg
        ...
        {/* Mobile nav */}
        <nav className="flex items-center gap-4 overflow-x-auto pb-3 md:hidden">
          <Link
            href="/"
