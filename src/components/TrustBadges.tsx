export default function TrustBadges() {
  return (
    <section className="bg-surface py-12" aria-labelledby="trust-heading">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-1 text-sm text-muted">SSL encrypted transactions</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="font-semibold text-foreground">Verified Products</h3>
            <p className="mt-1 text-sm text-muted">Curated from trusted sources</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-1 text-sm text-muted">Optimized for speed</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-1 text-sm text-muted">Always here to help</p>
          </div>
        </div>
      </div>
    </section>
